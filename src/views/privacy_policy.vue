<template>
  <div id="privacy" :class="{ container: true, 'dark-bg': darkMode }">
    <h1>Privacy Policy for Qmour.com</h1>

    <p>
      At qmour, accessible from https://qmour.com, one of our main priorities is
      the privacy of our visitors. This Privacy Policy document contains types
      of information that is collected and recorded by qmour and how we use it.
    </p>
    ...
    <p>
      ...
      and/or collect in qmour. This policy is not applicable to any information
      collected offline or via channels other than this website. Our Privacy
      Policy was created with the help of the
      <a
        href="https://justpaste.it/redirect/45sx2/https://www.privacypolicygenerator.info"
        >Privacy Policy Generator</a
      >
      and the
      <a
        href="https://justpaste.it/redirect/45sx2/https://www.generateprivacypolicy.com/"
    ...
    <p>
      ...
      <a
        href="https://justpaste.it/redirect/45sx2/https://www.privacypolicyonline.com/terms-conditions-generator/"
    ...
    <p>
      qmour follows a standard procedure of using log files. These files log
    ...
    <p>
      Like any other website, qmour uses 'cookies'. These cookies are used to
    ...
    <p>
      ...
      <a
        href="https://justpaste.it/redirect/45sx2/https://www.cookieconsent.com/what-are-cookies/"
        >"What Are Cookies"</a
      >.
    </p>
    ...
    <p>You may consult this list to find the Privacy Policy for each of the
      advertising partners of qmour.</p>

    <p>
      Third-party ad servers or ad networks uses technologies like cookies,
      JavaScript, or Web Beacons that are used in their respective
      advertisements and links that appear on qmour, which are sent directly to
    ...
    <p>
      Note that qmour has no access to or control over these cookies that are
    ...
    <p>
      qmour's Privacy Policy does not apply to other advertisers or websites.
    ...
    <p>
      qmour does not knowingly collect any Personal Identifiable Information
